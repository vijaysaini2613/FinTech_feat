...
import { Activity, Power, ShieldAlert, CheckCircle2 } from 'lucide-react';
    ...
    <div className="glass-panel p-5 rounded-2xl mb-6">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          ...
          <h3 className="font-bold text-slate-100 text-sm tracking-wide">Issuing Bank Uptime & Circuit Breaker Telemetry</h3>
        </div>
        <span className="text-xs text-slate-400 font-mono">Live NPCI Clearing Metrics</span>
      </div>
          ...
          return (
            <div
              ...
              className={`p-3.5 rounded-xl border transition-all ${
                isOutage
                  ? 'bg-rose-950/40 border-rose-600/40 shadow-lg shadow-rose-950/30'
            ...
            >
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold text-xs text-white">{bank.bank_name}</span>
                <span
              ...
              <div className="flex items-baseline justify-between mb-1.5">
                <span className="text-xs text-slate-400">Clearing Rate:</span>
              ...
              <button
                ...
                className={`w-full py-1 px-2 rounded-lg text-xs font-semibold flex items-center justify-center space-x-1.5 transition ${
                  isOutage
                    ? 'bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-300 border border-emerald-500/30'
                    : 'bg-rose-600/10 hover:bg-rose-600/20 text-rose-300 border border-rose-500/20'
                }`}
              >
